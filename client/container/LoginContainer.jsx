      ...
      <div className="Primary_Login_Container">
        <div className="Left_Container">
          ...
          <div className="Info">
            ...
            <button className="Google_Button">
              <img className="Google_Icon" src={google_icon} /> Sign in with
              Google
            </button>
            ...
            <section className="Remember_Pass">
              <h4>
                <input className="Remember_Check" type="checkbox" />
                Remember Me
              </h4>
        ...
        <div className="Advert">
          ...
          <section className="Glass_Blur">
            <p className="Review_Quote">
              “I’ve alway wanted a place to track and maintain my job searches
            ...
            <section className="Star_Container">
              ...
              <svg className="Review_SVG">
                <path
                  d="M58.2,0l5.3,10.7l11.9,1.7l-8.6,8.4l2,11.8l-10.6-5.6l-10.6,5.6l2-11.8L41,12.5l11.9-1.7L58.2,0z M94.9,10.7
